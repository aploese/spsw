...
public final class Unistd_Impl extends Unistd_H {
    ...
    protected interface NativeFunctions {
        ...
        @int32_t
        int close(@int32_t int fd);

        @size_t
        long pread(@int32_t int fildes, @Out byte[] buf, @size_t long nbyte, @__off_t long offset);

        @size_t
        long pread(@int32_t int fildes, @Out ByteBuffer buf, @size_t long nbyte, @__off_t long offset);

        @size_t
        long pwrite(@int32_t int fildes, @In byte[] buf, @size_t long nbyte, @__off_t long offset);

        @size_t
        long pwrite(@int32_t int fildes, @In ByteBuffer buf, @size_t long nbyte, @__off_t long offset);

        @size_t
        public long read(@int32_t int fildes, @Out byte[] buf, @size_t long nbyte);

        @size_t
        public long read(@int32_t int fildes, @Out ByteBuffer buffer, @size_t long nbyte);

        @size_t
        public long write(@int32_t int fildes, @In byte[] buf, @size_t long nbyte);

        @size_t
        public long write(@int32_t int fildes, @In ByteBuffer buffer, @size_t long nbyte);

        @int32_t
        int usleep(@__useconds_t int useconds);

        @__off_t
        public long lseek(@int32_t int fildes, @__off_t long offset, @int32_t int whence);

        /*
		 * int access (String name, int type); int faccessat (int fd, const char * file,
		 * int type, int flag); int pipe (int __pipedes[2]); unsigned int alarm (unsigned
    ...
    @Override
    public long lseek(int fildes, long offset, int whence) {
        return nativeFunctions.lseek(fildes, offset, whence);
    }
    ...
    @Override
    public long pread(int fildes, ByteBuffer buffer, long offset) {
        return fixBufferPos(buffer, nativeFunctions.pread(fildes, buffer, calcBufferReadBytes(buffer), offset));
    }
    ...
    @Override
    public long pwrite(int fildes, ByteBuffer buffer, long offset) {
        return fixBufferPos(buffer, nativeFunctions.pwrite(fildes, buffer, calcBufferWriteBytes(buffer), offset));
    }
    ...
    @Override
    public long read(int fildes, ByteBuffer buffer) {
        return fixBufferPos(buffer, nativeFunctions.read(fildes, buffer, calcBufferReadBytes(buffer)));
    }
    ...
    @Override
    public long write(int fildes, ByteBuffer buffer) {
        return fixBufferPos(buffer, nativeFunctions.write(fildes, buffer, calcBufferWriteBytes(buffer)));
    }
