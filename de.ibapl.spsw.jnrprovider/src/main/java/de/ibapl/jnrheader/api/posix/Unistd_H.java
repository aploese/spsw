...
public abstract class Unistd_H implements JnrHeader {
    ...
    public abstract long lseek(int fildes, long offset, int whence);

    public abstract long pread(int fildes, byte[] buf, long nbyte, long offset);

    public abstract long pread(int fildes, ByteBuffer buffer, long offset);

    public abstract long pwrite(int fildes, byte[] buf, long nbyte, long offset);
   
    public abstract long pwrite(int fildes, ByteBuffer buffer, long offset);

    protected abstract int R_OK();

    public abstract long read(int fildes, byte[] buf, long nbyte);

    public abstract long read(int fildes, ByteBuffer buffer);
    ...
    public abstract long write(int fildes, ByteBuffer buffer);
