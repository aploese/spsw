...
# 5 "/usr/share/mingw-w64/include/shellapi.h" 3
...
# 6 "/usr/share/mingw-w64/include/shellapi.h" 2 3


#define _INC_SHELLAPI 

#include <_mingw_unicode.h>
# 10 "/usr/share/mingw-w64/include/shellapi.h" 3
...
# 11 "/usr/share/mingw-w64/include/shellapi.h" 2 3
...
# 60 "/usr/share/mingw-w64/include/shellapi.h" 3
...
#define ExtractIcon __MINGW_NAME_AW(ExtractIcon)
  ...
  DECLSPEC_IMPORT UINT STDAPICALLTYPE DragQueryFileA (HDROP hDrop, UINT iFile, LPSTR lpszFile, UINT cch);
  DECLSPEC_IMPORT UINT STDAPICALLTYPE DragQueryFileW (HDROP hDrop, UINT iFile, LPWSTR lpszFile, UINT cch);
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE DragQueryPoint (HDROP hDrop, POINT *ppt);
  DECLSPEC_IMPORT void STDAPICALLTYPE DragFinish (HDROP hDrop);
  DECLSPEC_IMPORT void STDAPICALLTYPE DragAcceptFiles (HWND hWnd, WINBOOL fAccept);
  DECLSPEC_IMPORT HINSTANCE STDAPICALLTYPE ShellExecuteA (HWND hwnd, LPCSTR lpOperation, LPCSTR lpFile, LPCSTR lpParameters, LPCSTR lpDirectory, INT nShowCmd);
  DECLSPEC_IMPORT HINSTANCE STDAPICALLTYPE ShellExecuteW (HWND hwnd, LPCWSTR lpOperation, LPCWSTR lpFile, LPCWSTR lpParameters, LPCWSTR lpDirectory, INT nShowCmd);
  DECLSPEC_IMPORT HINSTANCE STDAPICALLTYPE FindExecutableA (LPCSTR lpFile, LPCSTR lpDirectory, LPSTR lpResult);
  DECLSPEC_IMPORT HINSTANCE STDAPICALLTYPE FindExecutableW (LPCWSTR lpFile, LPCWSTR lpDirectory, LPWSTR lpResult);
  DECLSPEC_IMPORT LPWSTR * STDAPICALLTYPE CommandLineToArgvW (LPCWSTR lpCmdLine, int *pNumArgs);
  DECLSPEC_IMPORT INT STDAPICALLTYPE ShellAboutA (HWND hWnd, LPCSTR szApp, LPCSTR szOtherStuff, HICON hIcon);
  DECLSPEC_IMPORT INT STDAPICALLTYPE ShellAboutW (HWND hWnd, LPCWSTR szApp, LPCWSTR szOtherStuff, HICON hIcon);
  DECLSPEC_IMPORT HICON STDAPICALLTYPE DuplicateIcon (HINSTANCE hInst, HICON hIcon);
  DECLSPEC_IMPORT HICON STDAPICALLTYPE ExtractAssociatedIconA (HINSTANCE hInst, LPSTR pszIconPath, WORD *piIcon);
  DECLSPEC_IMPORT HICON STDAPICALLTYPE ExtractAssociatedIconW (HINSTANCE hInst, LPWSTR pszIconPath, WORD *piIcon);
  DECLSPEC_IMPORT HICON STDAPICALLTYPE ExtractAssociatedIconExA (HINSTANCE hInst, LPSTR pszIconPath, WORD *piIconIndex, WORD *piIconId);
  DECLSPEC_IMPORT HICON STDAPICALLTYPE ExtractAssociatedIconExW (HINSTANCE hInst, LPWSTR pszIconPath, WORD *piIconIndex, WORD *piIconId);
  DECLSPEC_IMPORT HICON STDAPICALLTYPE ExtractIconA (HINSTANCE hInst, LPCSTR pszExeFileName, UINT nIconIndex);
  DECLSPEC_IMPORT HICON STDAPICALLTYPE ExtractIconW (HINSTANCE hInst, LPCWSTR pszExeFileName, UINT nIconIndex);
...
#define ABE_BOTTOM 3
  ...
  DECLSPEC_IMPORT UINT_PTR STDAPICALLTYPE SHAppBarMessage (DWORD dwMessage, PAPPBARDATA pData);
  DECLSPEC_IMPORT DWORD STDAPICALLTYPE DoEnvironmentSubstA (LPSTR pszSrc, UINT cchSrc);
  DECLSPEC_IMPORT DWORD STDAPICALLTYPE DoEnvironmentSubstW (LPWSTR pszSrc, UINT cchSrc);
  DECLSPEC_IMPORT UINT STDAPICALLTYPE ExtractIconExA (LPCSTR lpszFile, int nIconIndex, HICON *phiconLarge, HICON *phiconSmall, UINT nIcons);
  DECLSPEC_IMPORT UINT STDAPICALLTYPE ExtractIconExW (LPCWSTR lpszFile, int nIconIndex, HICON *phiconLarge, HICON *phiconSmall, UINT nIcons);
...
#define PO_REN_PORT 0x0034
  ...
  DECLSPEC_IMPORT int STDAPICALLTYPE SHFileOperationA (LPSHFILEOPSTRUCTA lpFileOp);
  DECLSPEC_IMPORT int STDAPICALLTYPE SHFileOperationW (LPSHFILEOPSTRUCTW lpFileOp);

#define SHFileOperation __MINGW_NAME_AW(SHFileOperation)

  DECLSPEC_IMPORT void STDAPICALLTYPE SHFreeNameMappings (HANDLE hNameMappings);
...
# 292 "/usr/share/mingw-w64/include/shellapi.h" 3
...
#define DUMMYUNIONNAME5 
  ...
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE ShellExecuteExA (SHELLEXECUTEINFOA *pExecInfo);
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE ShellExecuteExW (SHELLEXECUTEINFOW *pExecInfo);
...
#define ShellExecuteEx __MINGW_NAME_AW(ShellExecuteEx)
  ...
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE SHCreateProcessAsUserW (PSHCREATEPROCESSINFOW pscpi);
...
#define SHERB_NOSOUND 0x00000004
  ...
  DECLSPEC_IMPORT HRESULT STDAPICALLTYPE SHQueryRecycleBinA (LPCSTR pszRootPath, LPSHQUERYRBINFO pSHQueryRBInfo);
  DECLSPEC_IMPORT HRESULT STDAPICALLTYPE SHQueryRecycleBinW (LPCWSTR pszRootPath, LPSHQUERYRBINFO pSHQueryRBInfo);

#define SHQueryRecycleBin __MINGW_NAME_AW(SHQueryRecycleBin)

  DECLSPEC_IMPORT HRESULT STDAPICALLTYPE SHEmptyRecycleBinA (HWND hwnd, LPCSTR pszRootPath, DWORD dwFlags);
  DECLSPEC_IMPORT HRESULT STDAPICALLTYPE SHEmptyRecycleBinW (HWND hwnd, LPCWSTR pszRootPath, DWORD dwFlags);
...
# 540 "/usr/share/mingw-w64/include/shellapi.h" 3
...
#define NIIF_NOSOUND 0x00000010
  ...
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE Shell_NotifyIconA (DWORD dwMessage, PNOTIFYICONDATAA lpData);
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE Shell_NotifyIconW (DWORD dwMessage, PNOTIFYICONDATAW lpData);
...
#define SHGFI_OVERLAYINDEX 0x000000040
  ...
  DECLSPEC_IMPORT DWORD_PTR STDAPICALLTYPE SHGetFileInfoA (LPCSTR pszPath, DWORD dwFileAttributes, SHFILEINFOA *psfi, UINT cbFileInfo, UINT uFlags);
  DECLSPEC_IMPORT DWORD_PTR STDAPICALLTYPE SHGetFileInfoW (LPCWSTR pszPath, DWORD dwFileAttributes, SHFILEINFOW *psfi, UINT cbFileInfo, UINT uFlags);
...
#define SHGetDiskFreeSpace SHGetDiskFreeSpaceEx
  ...
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE SHGetDiskFreeSpaceExA (LPCSTR pszDirectoryName, ULARGE_INTEGER *pulFreeBytesAvailableToCaller, ULARGE_INTEGER *pulTotalNumberOfBytes, ULARGE_INTEGER *pulTotalNumberOfFreeBytes);
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE SHGetDiskFreeSpaceExW (LPCWSTR pszDirectoryName, ULARGE_INTEGER *pulFreeBytesAvailableToCaller, ULARGE_INTEGER *pulTotalNumberOfBytes, ULARGE_INTEGER *pulTotalNumberOfFreeBytes);
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE SHGetNewLinkInfoA (LPCSTR pszLinkTo, LPCSTR pszDir, LPSTR pszName, WINBOOL *pfMustCopy, UINT uFlags);
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE SHGetNewLinkInfoW (LPCWSTR pszLinkTo, LPCWSTR pszDir, LPWSTR pszName, WINBOOL *pfMustCopy, UINT uFlags);
...
#define PRINTACTION_SERVERPROPERTIES 7
  ...
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE SHInvokePrinterCommandA (HWND hwnd, UINT uAction, LPCSTR lpBuf1, LPCSTR lpBuf2, WINBOOL fModal);
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE SHInvokePrinterCommandW (HWND hwnd, UINT uAction, LPCWSTR lpBuf1, LPCWSTR lpBuf2, WINBOOL fModal);

#define SHInvokePrinterCommand __MINGW_NAME_AW(SHInvokePrinterCommand)
# 800 "/usr/share/mingw-w64/include/shellapi.h" 3
  DECLSPEC_IMPORT HRESULT STDAPICALLTYPE SHLoadNonloadedIconOverlayIdentifiers (void);
  DECLSPEC_IMPORT HRESULT STDAPICALLTYPE SHIsFileAvailableOffline (PCWSTR pwszPath, DWORD *pdwStatus);

#define OFFLINE_STATUS_LOCAL 0x0001
#define OFFLINE_STATUS_REMOTE 0x0002
#define OFFLINE_STATUS_INCOMPLETE 0x0004

  DECLSPEC_IMPORT HRESULT STDAPICALLTYPE SHSetLocalizedName (PCWSTR pszPath, PCWSTR pszResModule, int idsRes);
...
#define LWSTDAPIV_(type) EXTERN_C DECLSPEC_IMPORT type STDAPIVCALLTYPE
  ...
  EXTERN_C DECLSPEC_IMPORT int STDAPIVCALLTYPE ShellMessageBoxA (HINSTANCE hAppInst, HWND hWnd, LPCSTR lpcText, LPCSTR lpcTitle, UINT fuStyle,...);
  EXTERN_C DECLSPEC_IMPORT int STDAPIVCALLTYPE ShellMessageBoxW (HINSTANCE hAppInst, HWND hWnd, LPCWSTR lpcText, LPCWSTR lpcTitle, UINT fuStyle,...);

#define ShellMessageBox __MINGW_NAME_AW(ShellMessageBox)

  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE IsLFNDriveA (LPCSTR pszPath);
  DECLSPEC_IMPORT WINBOOL STDAPICALLTYPE IsLFNDriveW (LPCWSTR pszPath);
