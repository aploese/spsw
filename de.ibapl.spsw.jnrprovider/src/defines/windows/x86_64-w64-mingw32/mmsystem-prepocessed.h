...
# 9 "/usr/share/mingw-w64/include/mmsystem.h" 3
...
# 10 "/usr/share/mingw-w64/include/mmsystem.h" 2 3
#include <pshpack1.h>
...
# 28 "/usr/share/mingw-w64/include/mmsystem.h" 3
...
#define DRVCNF_RESTART 0x0002
  ...
  DECLSPEC_IMPORT LRESULT WINAPI CloseDriver(HDRVR hDriver,LPARAM lParam1,LPARAM lParam2);
  DECLSPEC_IMPORT HDRVR WINAPI OpenDriver(LPCWSTR szDriverName,LPCWSTR szSectionName,LPARAM lParam2);
  DECLSPEC_IMPORT LRESULT WINAPI SendDriverMessage(HDRVR hDriver,UINT message,LPARAM lParam1,LPARAM lParam2);
  DECLSPEC_IMPORT HMODULE WINAPI DrvGetModuleHandle(HDRVR hDriver);
  DECLSPEC_IMPORT HMODULE WINAPI GetDriverModuleHandle(HDRVR hDriver);
  DECLSPEC_IMPORT LRESULT WINAPI DefDriverProc(DWORD_PTR dwDriverIdentifier,HDRVR hdrvr,UINT uMsg,LPARAM lParam1,LPARAM lParam2);
...
#define OutputDebugStr OutputDebugString
  ...
  DECLSPEC_IMPORT WINBOOL WINAPI sndPlaySoundA(LPCSTR pszSound,UINT fuSound);
  DECLSPEC_IMPORT WINBOOL WINAPI sndPlaySoundW(LPCWSTR pszSound,UINT fuSound);
...
#define SND_ALIAS_SYSTEMDEFAULT sndAlias('S','D')
  ...
  DECLSPEC_IMPORT WINBOOL WINAPI PlaySoundA(LPCSTR pszSound,HMODULE hmod,DWORD fdwSound);
  DECLSPEC_IMPORT WINBOOL WINAPI PlaySoundW(LPCWSTR pszSound,HMODULE hmod,DWORD fdwSound);
...
#define _WAVEFORMATEX_ 
  ...
  DECLSPEC_IMPORT UINT WINAPI waveOutGetNumDevs(void);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetDevCapsA(UINT_PTR uDeviceID,LPWAVEOUTCAPSA pwoc,UINT cbwoc);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetDevCapsW(UINT_PTR uDeviceID,LPWAVEOUTCAPSW pwoc,UINT cbwoc);

#define waveOutGetDevCaps __MINGW_NAME_AW(waveOutGetDevCaps)

  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetVolume(HWAVEOUT hwo,LPDWORD pdwVolume);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutSetVolume(HWAVEOUT hwo,DWORD dwVolume);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetErrorTextA(MMRESULT mmrError,LPSTR pszText,UINT cchText);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetErrorTextW(MMRESULT mmrError,LPWSTR pszText,UINT cchText);

#define waveOutGetErrorText __MINGW_NAME_AW(waveOutGetErrorText)

  DECLSPEC_IMPORT MMRESULT WINAPI waveOutOpen(LPHWAVEOUT phwo,UINT uDeviceID,LPCWAVEFORMATEX pwfx,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutClose(HWAVEOUT hwo);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutPrepareHeader(HWAVEOUT hwo,LPWAVEHDR pwh,UINT cbwh);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutUnprepareHeader(HWAVEOUT hwo,LPWAVEHDR pwh,UINT cbwh);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutWrite(HWAVEOUT hwo,LPWAVEHDR pwh,UINT cbwh);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutPause(HWAVEOUT hwo);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutRestart(HWAVEOUT hwo);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutReset(HWAVEOUT hwo);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutBreakLoop(HWAVEOUT hwo);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetPosition(HWAVEOUT hwo,LPMMTIME pmmt,UINT cbmmt);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetPitch(HWAVEOUT hwo,LPDWORD pdwPitch);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutSetPitch(HWAVEOUT hwo,DWORD dwPitch);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetPlaybackRate(HWAVEOUT hwo,LPDWORD pdwRate);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutSetPlaybackRate(HWAVEOUT hwo,DWORD dwRate);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutGetID(HWAVEOUT hwo,LPUINT puDeviceID);
  DECLSPEC_IMPORT MMRESULT WINAPI waveOutMessage(HWAVEOUT hwo,UINT uMsg,DWORD_PTR dw1,DWORD_PTR dw2);
  DECLSPEC_IMPORT UINT WINAPI waveInGetNumDevs(void);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInGetDevCapsA(UINT_PTR uDeviceID,LPWAVEINCAPSA pwic,UINT cbwic);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInGetDevCapsW(UINT_PTR uDeviceID,LPWAVEINCAPSW pwic,UINT cbwic);

#define waveInGetDevCaps __MINGW_NAME_AW(waveInGetDevCaps)

  DECLSPEC_IMPORT MMRESULT WINAPI waveInGetErrorTextA(MMRESULT mmrError,LPSTR pszText,UINT cchText);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInGetErrorTextW(MMRESULT mmrError,LPWSTR pszText,UINT cchText);

#define waveInGetErrorText __MINGW_NAME_AW(waveInGetErrorText)

  DECLSPEC_IMPORT MMRESULT WINAPI waveInOpen(LPHWAVEIN phwi,UINT uDeviceID,LPCWAVEFORMATEX pwfx,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInClose(HWAVEIN hwi);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInPrepareHeader(HWAVEIN hwi,LPWAVEHDR pwh,UINT cbwh);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInUnprepareHeader(HWAVEIN hwi,LPWAVEHDR pwh,UINT cbwh);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInAddBuffer(HWAVEIN hwi,LPWAVEHDR pwh,UINT cbwh);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInStart(HWAVEIN hwi);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInStop(HWAVEIN hwi);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInReset(HWAVEIN hwi);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInGetPosition(HWAVEIN hwi,LPMMTIME pmmt,UINT cbmmt);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInGetID(HWAVEIN hwi,LPUINT puDeviceID);
  DECLSPEC_IMPORT MMRESULT WINAPI waveInMessage(HWAVEIN hwi,UINT uMsg,DWORD_PTR dw1,DWORD_PTR dw2);
...
#define MIDIPROP_TEMPO __MSABI_LONG(0x00000002)
  ...
  DECLSPEC_IMPORT UINT WINAPI midiOutGetNumDevs(void);
  DECLSPEC_IMPORT MMRESULT WINAPI midiStreamOpen(LPHMIDISTRM phms,LPUINT puDeviceID,DWORD cMidi,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
  DECLSPEC_IMPORT MMRESULT WINAPI midiStreamClose(HMIDISTRM hms);
  DECLSPEC_IMPORT MMRESULT WINAPI midiStreamProperty(HMIDISTRM hms,LPBYTE lppropdata,DWORD dwProperty);
  DECLSPEC_IMPORT MMRESULT WINAPI midiStreamPosition(HMIDISTRM hms,LPMMTIME lpmmt,UINT cbmmt);
  DECLSPEC_IMPORT MMRESULT WINAPI midiStreamOut(HMIDISTRM hms,LPMIDIHDR pmh,UINT cbmh);
  DECLSPEC_IMPORT MMRESULT WINAPI midiStreamPause(HMIDISTRM hms);
  DECLSPEC_IMPORT MMRESULT WINAPI midiStreamRestart(HMIDISTRM hms);
  DECLSPEC_IMPORT MMRESULT WINAPI midiStreamStop(HMIDISTRM hms);
  DECLSPEC_IMPORT MMRESULT WINAPI midiConnect(HMIDI hmi,HMIDIOUT hmo,LPVOID pReserved);
  DECLSPEC_IMPORT MMRESULT WINAPI midiDisconnect(HMIDI hmi,HMIDIOUT hmo,LPVOID pReserved);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutGetDevCapsA(UINT_PTR uDeviceID,LPMIDIOUTCAPSA pmoc,UINT cbmoc);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutGetDevCapsW(UINT_PTR uDeviceID,LPMIDIOUTCAPSW pmoc,UINT cbmoc);

#define midiOutGetDevCaps __MINGW_NAME_AW(midiOutGetDevCaps)

  DECLSPEC_IMPORT MMRESULT WINAPI midiOutGetVolume(HMIDIOUT hmo,LPDWORD pdwVolume);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutSetVolume(HMIDIOUT hmo,DWORD dwVolume);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutGetErrorTextA(MMRESULT mmrError,LPSTR pszText,UINT cchText);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutGetErrorTextW(MMRESULT mmrError,LPWSTR pszText,UINT cchText);

#define midiOutGetErrorText __MINGW_NAME_AW(midiOutGetErrorText)

  DECLSPEC_IMPORT MMRESULT WINAPI midiOutOpen(LPHMIDIOUT phmo,UINT uDeviceID,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutClose(HMIDIOUT hmo);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutPrepareHeader(HMIDIOUT hmo,LPMIDIHDR pmh,UINT cbmh);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutUnprepareHeader(HMIDIOUT hmo,LPMIDIHDR pmh,UINT cbmh);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutShortMsg(HMIDIOUT hmo,DWORD dwMsg);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutLongMsg(HMIDIOUT hmo,LPMIDIHDR pmh,UINT cbmh);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutReset(HMIDIOUT hmo);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutCachePatches(HMIDIOUT hmo,UINT uBank,LPWORD pwpa,UINT fuCache);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutCacheDrumPatches(HMIDIOUT hmo,UINT uPatch,LPWORD pwkya,UINT fuCache);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutGetID(HMIDIOUT hmo,LPUINT puDeviceID);
  DECLSPEC_IMPORT MMRESULT WINAPI midiOutMessage(HMIDIOUT hmo,UINT uMsg,DWORD_PTR dw1,DWORD_PTR dw2);
  DECLSPEC_IMPORT UINT WINAPI midiInGetNumDevs(void);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInGetDevCapsA(UINT_PTR uDeviceID,LPMIDIINCAPSA pmic,UINT cbmic);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInGetDevCapsW(UINT_PTR uDeviceID,LPMIDIINCAPSW pmic,UINT cbmic);

#define midiInGetDevCaps __MINGW_NAME_AW(midiInGetDevCaps)

  DECLSPEC_IMPORT MMRESULT WINAPI midiInGetErrorTextA(MMRESULT mmrError,LPSTR pszText,UINT cchText);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInGetErrorTextW(MMRESULT mmrError,LPWSTR pszText,UINT cchText);

#define midiInGetErrorText __MINGW_NAME_AW(midiInGetErrorText)

  DECLSPEC_IMPORT MMRESULT WINAPI midiInOpen(LPHMIDIIN phmi,UINT uDeviceID,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInClose(HMIDIIN hmi);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInPrepareHeader(HMIDIIN hmi,LPMIDIHDR pmh,UINT cbmh);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInUnprepareHeader(HMIDIIN hmi,LPMIDIHDR pmh,UINT cbmh);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInAddBuffer(HMIDIIN hmi,LPMIDIHDR pmh,UINT cbmh);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInStart(HMIDIIN hmi);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInStop(HMIDIIN hmi);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInReset(HMIDIIN hmi);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInGetID(HMIDIIN hmi,LPUINT puDeviceID);
  DECLSPEC_IMPORT MMRESULT WINAPI midiInMessage(HMIDIIN hmi,UINT uMsg,DWORD_PTR dw1,DWORD_PTR dw2);
...
#define AUXCAPS_LRVOLUME 0x0002
  ...
  DECLSPEC_IMPORT UINT WINAPI auxGetNumDevs(void);
  DECLSPEC_IMPORT MMRESULT WINAPI auxGetDevCapsA(UINT_PTR uDeviceID,LPAUXCAPSA pac,UINT cbac);
  DECLSPEC_IMPORT MMRESULT WINAPI auxGetDevCapsW(UINT_PTR uDeviceID,LPAUXCAPSW pac,UINT cbac);

#define auxGetDevCaps __MINGW_NAME_AW(auxGetDevCaps)

  DECLSPEC_IMPORT MMRESULT WINAPI auxSetVolume(UINT uDeviceID,DWORD dwVolume);
  DECLSPEC_IMPORT MMRESULT WINAPI auxGetVolume(UINT uDeviceID,LPDWORD pdwVolume);
  DECLSPEC_IMPORT MMRESULT WINAPI auxOutMessage(UINT uDeviceID,UINT uMsg,DWORD_PTR dw1,DWORD_PTR dw2);
...
#define MIXER_OBJECTF_AUX __MSABI_LONG(0x50000000)
  ...
  DECLSPEC_IMPORT UINT WINAPI mixerGetNumDevs(void);
  ...
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetDevCapsA(UINT_PTR uMxId,LPMIXERCAPSA pmxcaps,UINT cbmxcaps);
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetDevCapsW(UINT_PTR uMxId,LPMIXERCAPSW pmxcaps,UINT cbmxcaps);

#define mixerGetDevCaps __MINGW_NAME_AW(mixerGetDevCaps)

  DECLSPEC_IMPORT MMRESULT WINAPI mixerOpen(LPHMIXER phmx,UINT uMxId,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
  DECLSPEC_IMPORT MMRESULT WINAPI mixerClose(HMIXER hmx);
  DECLSPEC_IMPORT DWORD WINAPI mixerMessage(HMIXER hmx,UINT uMsg,DWORD_PTR dwParam1,DWORD_PTR dwParam2);
...
#define MIXERLINE_TARGETTYPE_AUX 5
  ...
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetLineInfoA(HMIXEROBJ hmxobj,LPMIXERLINEA pmxl,DWORD fdwInfo);
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetLineInfoW(HMIXEROBJ hmxobj,LPMIXERLINEW pmxl,DWORD fdwInfo);
...
#define MIXER_GETLINEINFOF_QUERYMASK __MSABI_LONG(0x0000000F)
  ...
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetID(HMIXEROBJ hmxobj,UINT *puMxId,DWORD fdwId);
...
#define MIXERCONTROL_CONTROLTYPE_MILLITIME (MIXERCONTROL_CT_CLASS_TIME | MIXERCONTROL_CT_SC_TIME_MILLISECS | MIXERCONTROL_CT_UNITS_UNSIGNED)
  ...
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetLineControlsA(HMIXEROBJ hmxobj,LPMIXERLINECONTROLSA pmxlc,DWORD fdwControls);
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetLineControlsW(HMIXEROBJ hmxobj,LPMIXERLINECONTROLSW pmxlc,DWORD fdwControls);
...
#define MIXER_GETLINECONTROLSF_QUERYMASK __MSABI_LONG(0x0000000F)
  ...
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetControlDetailsA(HMIXEROBJ hmxobj,LPMIXERCONTROLDETAILS pmxcd,DWORD fdwDetails);
  DECLSPEC_IMPORT MMRESULT WINAPI mixerGetControlDetailsW(HMIXEROBJ hmxobj,LPMIXERCONTROLDETAILS pmxcd,DWORD fdwDetails);
...
#define MIXER_GETCONTROLDETAILSF_QUERYMASK __MSABI_LONG(0x0000000F)
  ...
  DECLSPEC_IMPORT MMRESULT WINAPI mixerSetControlDetails(HMIXEROBJ hmxobj,LPMIXERCONTROLDETAILS pmxcd,DWORD fdwDetails);
...
#define TIME_KILL_SYNCHRONOUS 0x0100
  ...
  DECLSPEC_IMPORT MMRESULT WINAPI timeGetSystemTime(LPMMTIME pmmt,UINT cbmmt);
  DECLSPEC_IMPORT DWORD WINAPI timeGetTime(void);
  DECLSPEC_IMPORT MMRESULT WINAPI timeSetEvent(UINT uDelay,UINT uResolution,LPTIMECALLBACK fptc,DWORD_PTR dwUser,UINT fuEvent);
  DECLSPEC_IMPORT MMRESULT WINAPI timeKillEvent(UINT uTimerID);
  DECLSPEC_IMPORT MMRESULT WINAPI timeGetDevCaps(LPTIMECAPS ptc,UINT cbtc);
  DECLSPEC_IMPORT MMRESULT WINAPI timeBeginPeriod(UINT uPeriod);
  DECLSPEC_IMPORT MMRESULT WINAPI timeEndPeriod(UINT uPeriod);
...
#define JOYCAPS_POVCTS 0x0040
  ...
  DECLSPEC_IMPORT UINT WINAPI joyGetNumDevs(void);
  DECLSPEC_IMPORT MMRESULT WINAPI joyGetDevCapsA(UINT_PTR uJoyID,LPJOYCAPSA pjc,UINT cbjc);
  DECLSPEC_IMPORT MMRESULT WINAPI joyGetDevCapsW(UINT_PTR uJoyID,LPJOYCAPSW pjc,UINT cbjc);

#define joyGetDevCaps __MINGW_NAME_AW(joyGetDevCaps)

  DECLSPEC_IMPORT MMRESULT WINAPI joyGetPos(UINT uJoyID,LPJOYINFO pji);
  DECLSPEC_IMPORT MMRESULT WINAPI joyGetPosEx(UINT uJoyID,LPJOYINFOEX pji);
  DECLSPEC_IMPORT MMRESULT WINAPI joyGetThreshold(UINT uJoyID,LPUINT puThreshold);
  DECLSPEC_IMPORT MMRESULT WINAPI joyReleaseCapture(UINT uJoyID);
  DECLSPEC_IMPORT MMRESULT WINAPI joySetCapture(HWND hwnd,UINT uJoyID,UINT uPeriod,WINBOOL fChanged);
  DECLSPEC_IMPORT MMRESULT WINAPI joySetThreshold(UINT uJoyID,UINT uThreshold);
...
#define mmioFOURCC(ch0,ch1,ch2,ch3) MAKEFOURCC(ch0,ch1,ch2,ch3)
  ...
  DECLSPEC_IMPORT FOURCC WINAPI mmioStringToFOURCCA(LPCSTR sz,UINT uFlags);
  DECLSPEC_IMPORT FOURCC WINAPI mmioStringToFOURCCW(LPCWSTR sz,UINT uFlags);

#define mmioStringToFOURCC __MINGW_NAME_AW(mmioStringToFOURCC)

  DECLSPEC_IMPORT LPMMIOPROC WINAPI mmioInstallIOProcA(FOURCC fccIOProc,LPMMIOPROC pIOProc,DWORD dwFlags);
  DECLSPEC_IMPORT LPMMIOPROC WINAPI mmioInstallIOProcW(FOURCC fccIOProc,LPMMIOPROC pIOProc,DWORD dwFlags);

#define mmioInstallIOProc __MINGW_NAME_AW(mmioInstallIOProc)

  DECLSPEC_IMPORT HMMIO WINAPI mmioOpenA(LPSTR pszFileName,LPMMIOINFO pmmioinfo,DWORD fdwOpen);
  DECLSPEC_IMPORT HMMIO WINAPI mmioOpenW(LPWSTR pszFileName,LPMMIOINFO pmmioinfo,DWORD fdwOpen);

#define mmioOpen __MINGW_NAME_AW(mmioOpen)

  DECLSPEC_IMPORT MMRESULT WINAPI mmioRenameA(LPCSTR pszFileName,LPCSTR pszNewFileName,LPCMMIOINFO pmmioinfo,DWORD fdwRename);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioRenameW(LPCWSTR pszFileName,LPCWSTR pszNewFileName,LPCMMIOINFO pmmioinfo,DWORD fdwRename);

#define mmioRename __MINGW_NAME_AW(mmioRename)

  DECLSPEC_IMPORT MMRESULT WINAPI mmioClose(HMMIO hmmio,UINT fuClose);
  DECLSPEC_IMPORT LONG WINAPI mmioRead(HMMIO hmmio,HPSTR pch,LONG cch);
  DECLSPEC_IMPORT LONG WINAPI mmioWrite(HMMIO hmmio,const char *pch,LONG cch);
  DECLSPEC_IMPORT LONG WINAPI mmioSeek(HMMIO hmmio,LONG lOffset,int iOrigin);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioGetInfo(HMMIO hmmio,LPMMIOINFO pmmioinfo,UINT fuInfo);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioSetInfo(HMMIO hmmio,LPCMMIOINFO pmmioinfo,UINT fuInfo);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioSetBuffer(HMMIO hmmio,LPSTR pchBuffer,LONG cchBuffer,UINT fuBuffer);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioFlush(HMMIO hmmio,UINT fuFlush);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioAdvance(HMMIO hmmio,LPMMIOINFO pmmioinfo,UINT fuAdvance);
  DECLSPEC_IMPORT LRESULT WINAPI mmioSendMessage(HMMIO hmmio,UINT uMsg,LPARAM lParam1,LPARAM lParam2);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioDescend(HMMIO hmmio,LPMMCKINFO pmmcki,const MMCKINFO *pmmckiParent,UINT fuDescend);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioAscend(HMMIO hmmio,LPMMCKINFO pmmcki,UINT fuAscend);
  DECLSPEC_IMPORT MMRESULT WINAPI mmioCreateChunk(HMMIO hmmio,LPMMCKINFO pmmcki,UINT fuCreate);
...
#define _MCIDEVICEID_ 
  ...
  DECLSPEC_IMPORT MCIERROR WINAPI mciSendCommandA(MCIDEVICEID mciId,UINT uMsg,DWORD_PTR dwParam1,DWORD_PTR dwParam2);
  DECLSPEC_IMPORT MCIERROR WINAPI mciSendCommandW(MCIDEVICEID mciId,UINT uMsg,DWORD_PTR dwParam1,DWORD_PTR dwParam2);

#define mciSendCommand __MINGW_NAME_AW(mciSendCommand)

  DECLSPEC_IMPORT MCIERROR WINAPI mciSendStringA(LPCSTR lpstrCommand,LPSTR lpstrReturnString,UINT uReturnLength,HWND hwndCallback);
  DECLSPEC_IMPORT MCIERROR WINAPI mciSendStringW(LPCWSTR lpstrCommand,LPWSTR lpstrReturnString,UINT uReturnLength,HWND hwndCallback);

#define mciSendString __MINGW_NAME_AW(mciSendString)

  DECLSPEC_IMPORT MCIDEVICEID WINAPI mciGetDeviceIDA(LPCSTR pszDevice);
  DECLSPEC_IMPORT MCIDEVICEID WINAPI mciGetDeviceIDW(LPCWSTR pszDevice);

#define mciGetDeviceID __MINGW_NAME_AW(mciGetDeviceID)

  DECLSPEC_IMPORT MCIDEVICEID WINAPI mciGetDeviceIDFromElementIDA(DWORD dwElementID,LPCSTR lpstrType);
  DECLSPEC_IMPORT MCIDEVICEID WINAPI mciGetDeviceIDFromElementIDW(DWORD dwElementID,LPCWSTR lpstrType);

#define mciGetDeviceIDFromElementID __MINGW_NAME_AW(mciGetDeviceIDFromElementID)

  DECLSPEC_IMPORT WINBOOL WINAPI mciGetErrorStringA(MCIERROR mcierr,LPSTR pszText,UINT cchText);
  DECLSPEC_IMPORT WINBOOL WINAPI mciGetErrorStringW(MCIERROR mcierr,LPWSTR pszText,UINT cchText);

#define mciGetErrorString __MINGW_NAME_AW(mciGetErrorString)

  DECLSPEC_IMPORT WINBOOL WINAPI mciSetYieldProc(MCIDEVICEID mciId,YIELDPROC fpYieldProc,DWORD dwYieldData);
  DECLSPEC_IMPORT HTASK WINAPI mciGetCreatorTask(MCIDEVICEID mciId);
  DECLSPEC_IMPORT YIELDPROC WINAPI mciGetYieldProc(MCIDEVICEID mciId,LPDWORD pdwYieldData);
