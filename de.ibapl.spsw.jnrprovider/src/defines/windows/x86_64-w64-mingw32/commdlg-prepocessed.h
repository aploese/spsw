...
# 6 "/usr/share/mingw-w64/include/commdlg.h" 3
...
# 7 "/usr/share/mingw-w64/include/commdlg.h" 2 3


#define _INC_COMMDLG 

#include <_mingw_unicode.h>
# 11 "/usr/share/mingw-w64/include/commdlg.h" 3
...
# 12 "/usr/share/mingw-w64/include/commdlg.h" 2 3
...
#include <prsht.h>
# 19 "/usr/share/mingw-w64/include/commdlg.h" 3
...
#include <pshpack8.h>
# 30 "/usr/share/mingw-w64/include/prsht.h" 3
...
#pragma pack(push,8)
# 31 "/usr/share/mingw-w64/include/prsht.h" 2 3
...
#define _PROPSHEETPAGEW_V3 _PROPSHEETPAGEW
  ...
  typedef struct _PROPSHEETPAGEA_V1 {
    DWORD dwSize,dwFlags; HINSTANCE hInstance; __C89_NAMELESS union { LPCSTR pszTemplate; PROPSHEETPAGE_RESOURCE pResource; } DUMMYUNIONNAME; __C89_NAMELESS union { HICON hIcon; LPCSTR pszIcon; } DUMMYUNIONNAME2; LPCSTR pszTitle; DLGPROC pfnDlgProc; LPARAM lParam; LPFNPSPCALLBACKA pfnCallback; UINT *pcRefParent;
  ...
  typedef struct _PROPSHEETPAGEW_V1 {
    DWORD dwSize, dwFlags; HINSTANCE hInstance; __C89_NAMELESS union { LPCWSTR pszTemplate; PROPSHEETPAGE_RESOURCE pResource; } DUMMYUNIONNAME; __C89_NAMELESS union { HICON hIcon; LPCWSTR pszIcon; } DUMMYUNIONNAME2; LPCWSTR pszTitle; DLGPROC pfnDlgProc; LPARAM lParam; LPFNPSPCALLBACKW pfnCallback; UINT *pcRefParent;
...
#define PSCB_BUTTONPRESSED 3
  ...
  DECLSPEC_IMPORT HPROPSHEETPAGE WINAPI CreatePropertySheetPageA(LPCPROPSHEETPAGEA constPropSheetPagePointer);
  DECLSPEC_IMPORT HPROPSHEETPAGE WINAPI CreatePropertySheetPageW(LPCPROPSHEETPAGEW constPropSheetPagePointer);
  DECLSPEC_IMPORT WINBOOL WINAPI DestroyPropertySheetPage(HPROPSHEETPAGE);
  DECLSPEC_IMPORT INT_PTR WINAPI PropertySheetA(LPCPROPSHEETHEADERA);
  DECLSPEC_IMPORT INT_PTR WINAPI PropertySheetW(LPCPROPSHEETHEADERW);
...
# 20 "/usr/share/mingw-w64/include/commdlg.h" 2 3
...
#define OPENFILENAME_SIZE_VERSION_400 __MINGW_NAME_AW(OPENFILENAME_SIZE_VERSION_400)
  ...
  DECLSPEC_IMPORT WINBOOL WINAPI GetOpenFileNameW(LPOPENFILENAMEW);

#define GetOpenFileName __MINGW_NAME_AW(GetOpenFileName)

  DECLSPEC_IMPORT WINBOOL WINAPI GetSaveFileNameA(LPOPENFILENAMEA);
  DECLSPEC_IMPORT WINBOOL WINAPI GetSaveFileNameW(LPOPENFILENAMEW);

#define GetSaveFileName __MINGW_NAME_AW(GetSaveFileName)

  DECLSPEC_IMPORT short WINAPI GetFileTitleA(LPCSTR,LPSTR,WORD);
  DECLSPEC_IMPORT short WINAPI GetFileTitleW(LPCWSTR,LPWSTR,WORD);
...
#define CommDlg_OpenSave_SetDefExt(_hdlg,_pszext) (void)SNDMSG(_hdlg,CDM_SETDEFEXT,0,(LPARAM)(LPSTR)_pszext)
  ...
  DECLSPEC_IMPORT WINBOOL WINAPI ChooseColorA(LPCHOOSECOLORA);
  DECLSPEC_IMPORT WINBOOL WINAPI ChooseColorW(LPCHOOSECOLORW);
...
#define FR_MATCHALEFHAMZA 0x80000000
  ...
  DECLSPEC_IMPORT HWND WINAPI FindTextA(LPFINDREPLACEA);
  DECLSPEC_IMPORT HWND WINAPI FindTextW(LPFINDREPLACEW);

#define FindText __MINGW_NAME_AW(FindText)

  DECLSPEC_IMPORT HWND WINAPI ReplaceTextA(LPFINDREPLACEA);
  DECLSPEC_IMPORT HWND WINAPI ReplaceTextW(LPFINDREPLACEW);
...
#define ReplaceText __MINGW_NAME_AW(ReplaceText)
  ...
  DECLSPEC_IMPORT WINBOOL WINAPI ChooseFontA(LPCHOOSEFONTA);
  DECLSPEC_IMPORT WINBOOL WINAPI ChooseFontW(LPCHOOSEFONTW);
...
#define CD_LBSELADD 2
  ...
  DECLSPEC_IMPORT WINBOOL WINAPI PrintDlgA(LPPRINTDLGA);
  DECLSPEC_IMPORT WINBOOL WINAPI PrintDlgW(LPPRINTDLGW);

#define PrintDlg __MINGW_NAME_AW(PrintDlg)
# 661 "/usr/share/mingw-w64/include/commdlg.h" 3
...
#define DN_DEFAULTPRN 0x1
  ...
  DECLSPEC_IMPORT DWORD WINAPI CommDlgExtendedError(VOID);
...
#define WM_PSD_YAFULLPAGERECT (WM_USER+6)
  ...
  DECLSPEC_IMPORT WINBOOL WINAPI PageSetupDlgA(LPPAGESETUPDLGA);
  DECLSPEC_IMPORT WINBOOL WINAPI PageSetupDlgW(LPPAGESETUPDLGW);
