...
# 33 "/usr/include/dlfcn.h" 3 4
#define _DLFCN_H_ 

#include <sys/_types.h>
# 35 "/usr/include/dlfcn.h" 3 4
...
int dladdr(const void * restrict, Dl_info * restrict);
dlfunc_t dlfunc(void * restrict, const char * restrict);
...
void *dlvsym(void * restrict, const char * restrict,
     const char * restrict);
