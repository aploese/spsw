...
# 30 "/usr/include/mqueue.h" 3 4
#define _MQUEUE_H_ 

#include <sys/cdefs.h>
# 32 "/usr/include/mqueue.h" 3 4
...
# 33 "/usr/include/mqueue.h" 2 3 4
#include <sys/types.h>
# 33 "/usr/include/mqueue.h" 3 4
# 1 "/usr/include/sys/types.h" 1 3 4
# 39 "/usr/include/sys/types.h" 3 4
...
# 34 "/usr/include/x86/endian.h" 3 4
...
#define __bswap32_gen(x) (((__uint32_t)__bswap16((x) & 0xffff) << 16) | __bswap16((x) >> 16))

#define __bswap64_gen(x) (((__uint64_t)__bswap32((x) & 0xffffffff) << 32) | __bswap32((x) >> 32))



#define __bswap16(x) ((__uint16_t)(__builtin_constant_p(x) ? __bswap16_gen((__uint16_t)(x)) : __bswap16_var(x)))


#define __bswap32(x) (__builtin_constant_p(x) ? __bswap32_gen((__uint32_t)(x)) : __bswap32_var(x))


#define __bswap64(x) (__builtin_constant_p(x) ? __bswap64_gen((__uint64_t)(x)) : __bswap64_var(x))
...
# 37 "/usr/include/sys/_pthreadtypes.h" 3 4
...
# 31 "/usr/include/sys/_stdint.h" 3 4
...
# 30 "/usr/include/sys/_timeval.h" 3 4
...
# 35 "/usr/include/sys/_timespec.h" 3 4
...
# 34 "/usr/include/mqueue.h" 2 3 4
#include <sys/mqueue.h>
# 34 "/usr/include/mqueue.h" 3 4
# 1 "/usr/include/sys/mqueue.h" 1 3 4
# 30 "/usr/include/sys/mqueue.h" 3 4
...
# 35 "/usr/include/mqueue.h" 2 3 4
#include <sys/signal.h>
# 35 "/usr/include/mqueue.h" 3 4
# 1 "/usr/include/sys/signal.h" 1 3 4
# 39 "/usr/include/sys/signal.h" 3 4
...
# 35 "/usr/include/x86/signal.h" 3 4
...
#define T_USER 0x100
# 6 "/usr/include/machine/trap.h" 2 3 4
...
# 6 "/usr/include/machine/signal.h" 2 3 4
...
#include <sys/_pthreadtypes.h>
#include <sys/_timespec.h>
# 69 "/usr/include/sys/signal.h" 3 4
#define SIGHUP 1
...
# 159 "/usr/include/sys/signal.h" 3 4
...
# 433 "/usr/include/sys/signal.h" 3 4
struct sigstack {
 void *ss_sp;
 int ss_onstack;
};
