...
#define __VERSION__ "8.0.1 20180325 (experimental)"
...
# 37 "/usr/include/sys/cdefs.h" 3 4
...
# 553 "/usr/include/sys/cdefs.h" 3 4
...
# 775 "/usr/include/sys/cdefs.h" 3 4
...
# 834 "/usr/include/sys/cdefs.h" 3 4
...
# 40 "/usr/include/x86/_types.h" 3 4
...
# 34 "/usr/include/x86/_limits.h" 3 4
#define _MACHINE__LIMITS_H_ 
# 45 "/usr/include/x86/_limits.h" 3 4
#define __CHAR_BIT 8
...
# 96 "/usr/include/x86/_limits.h" 3 4
...
# 53 "/usr/include/x86/_types.h" 3 4
...
#include <_ctype.h>
# 37 "/usr/include/wctype.h" 3 4
# 1 "/usr/include/_ctype.h" 1 3 4
# 43 "/usr/include/_ctype.h" 3 4
#define __CTYPE_H_ 
...
# 93 "/usr/include/wctype.h" 3 4
# 1 "/usr/include/xlocale/_ctype.h" 1 3 4
# 37 "/usr/include/xlocale/_ctype.h" 3 4
...
# 65 "/usr/include/xlocale/_ctype.h" 3 4
...
__maskrune_l(__ct_rune_t __c, unsigned long __f, locale_t __loc)
{
 ...
 return ((__c < 0 || __c >= (1 <<8 )) ? ___runetype_l(__c, __loc) :
...
#define XLOCALE_ISCTYPE(fname,cat) _XLOCALE_INLINE int isw ##fname ##_l(int, locale_t); _XLOCALE_INLINE int isw ##fname ##_l(int __c, locale_t __l) { return __istype_l(__c, cat, __l); }
# 122 "/usr/include/xlocale/_ctype.h" 3 4
inline int iswalnum_l(int, locale_t); inline int iswalnum_l(int __c, locale_t __l) { return __istype_l(__c, 0x00000100L|0x00000400L|0x00400000L, __l); }
inline int iswalpha_l(int, locale_t); inline int iswalpha_l(int __c, locale_t __l) { return __istype_l(__c, 0x00000100L, __l); }
inline int iswblank_l(int, locale_t); inline int iswblank_l(int __c, locale_t __l) { return __istype_l(__c, 0x00020000L, __l); }
inline int iswcntrl_l(int, locale_t); inline int iswcntrl_l(int __c, locale_t __l) { return __istype_l(__c, 0x00000200L, __l); }
inline int iswdigit_l(int, locale_t); inline int iswdigit_l(int __c, locale_t __l) { return __istype_l(__c, 0x00000400L, __l); }
inline int iswgraph_l(int, locale_t); inline int iswgraph_l(int __c, locale_t __l) { return __istype_l(__c, 0x00000800L, __l); }
inline int iswhexnumber_l(int, locale_t); inline int iswhexnumber_l(int __c, locale_t __l) { return __istype_l(__c, 0x00010000L, __l); }
inline int iswideogram_l(int, locale_t); inline int iswideogram_l(int __c, locale_t __l) { return __istype_l(__c, 0x00080000L, __l); }
inline int iswlower_l(int, locale_t); inline int iswlower_l(int __c, locale_t __l) { return __istype_l(__c, 0x00001000L, __l); }
inline int iswnumber_l(int, locale_t); inline int iswnumber_l(int __c, locale_t __l) { return __istype_l(__c, 0x00000400L|0x00400000L, __l); }
inline int iswphonogram_l(int, locale_t); inline int iswphonogram_l(int __c, locale_t __l) { return __istype_l(__c, 0x00200000L, __l); }
inline int iswprint_l(int, locale_t); inline int iswprint_l(int __c, locale_t __l) { return __istype_l(__c, 0x00040000L, __l); }
inline int iswpunct_l(int, locale_t); inline int iswpunct_l(int __c, locale_t __l) { return __istype_l(__c, 0x00002000L, __l); }
inline int iswrune_l(int, locale_t); inline int iswrune_l(int __c, locale_t __l) { return __istype_l(__c, 0xFFFFFF00L, __l); }
inline int iswspace_l(int, locale_t); inline int iswspace_l(int __c, locale_t __l) { return __istype_l(__c, 0x00004000L, __l); }
inline int iswspecial_l(int, locale_t); inline int iswspecial_l(int __c, locale_t __l) { return __istype_l(__c, 0x00100000L, __l); }
inline int iswupper_l(int, locale_t); inline int iswupper_l(int __c, locale_t __l) { return __istype_l(__c, 0x00008000L, __l); }
inline int iswxdigit_l(int, locale_t); inline int iswxdigit_l(int __c, locale_t __l) { return __istype_l(__c, 0x00010000L, __l); }
#undef XLOCALE_ISCTYPE


inline int towlower_l(int, locale_t);
inline int __wcwidth_l(__ct_rune_t, locale_t);
inline int towupper_l(int, locale_t);

inline int towlower_l(int __c, locale_t __l)
{
 int __limit;
 _RuneLocale *__runes = __runes_for_locale(__l, &__limit);
 return (__c < 0 || __c >= (1 <<8 )) ? ___tolower_l(__c, __l) :
        __runes->__maplower[__c];
}
inline int towupper_l(int __c, locale_t __l)
{
 int __limit;
 _RuneLocale *__runes = __runes_for_locale(__l, &__limit);
 return (__c < 0 || __c >= (1 <<8 )) ? ___toupper_l(__c, __l) :
...
__wcwidth_l(__ct_rune_t _c, locale_t __l)
{
 ...
 if (_c == 0)
  return (0);
 _x = (unsigned int)__maskrune_l(_c, 0xe0000000L|0x00040000L, __l);
 if ((_x & 0xe0000000L) != 0)
  return ((_x & 0xe0000000L) >> 30);
 return ((_x & 0x00040000L) != 0 ? 1 : -1);
}
