...
#define XLOCALE_ISCTYPE(__fname,__cat) _XLOCALE_INLINE int is ##__fname ##_l(int, locale_t); _XLOCALE_INLINE int is ##__fname ##_l(int __c, locale_t __l) { return __sbistype_l(__c, __cat, __l); }
