...
# 51 "/usr/include/sys/signal.h" 2 3 4
...
# 52 "/usr/include/sys/signal.h" 2 3 4
...
# 33 "/usr/include/x86/ucontext.h" 3 4
#define _X86_UCONTEXT_H_ 
# 99 "/usr/include/x86/ucontext.h" 3 4
...
int pthread_sigmask(int, const __sigset_t * restrict,
     __sigset_t * restrict);
