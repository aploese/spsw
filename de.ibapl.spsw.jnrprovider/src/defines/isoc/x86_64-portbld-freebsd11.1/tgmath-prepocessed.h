...
#include <tgmath.h>
# 1 "c.c"
# 1 "/usr/local/lib/gcc8/gcc/x86_64-portbld-freebsd11.1/8.0.1/include/tgmath.h" 1 3 4
# 30 "/usr/local/lib/gcc8/gcc/x86_64-portbld-freebsd11.1/8.0.1/include/tgmath.h" 3 4
#define _TGMATH_H 

#include <math.h>
# 32 "/usr/local/lib/gcc8/gcc/x86_64-portbld-freebsd11.1/8.0.1/include/tgmath.h" 3 4
# 1 "/usr/include/math.h" 1 3 4
# 18 "/usr/include/math.h" 3 4
#define _MATH_H_ 
...
#define __fp_type_select(x,f,d,ld) __builtin_choose_expr( __builtin_types_compatible_p(__typeof(x), long double), ld(x), __builtin_choose_expr( __builtin_types_compatible_p(__typeof(x), double), d(x), __builtin_choose_expr( __builtin_types_compatible_p(__typeof(x), float), f(x), (void)0)))
# 109 "/usr/include/math.h" 3 4
#define fpclassify(x) __fp_type_select(x, __fpclassifyf, __fpclassifyd, __fpclassifyl)
...
#define isnan(x) __fp_type_select(x, __inline_isnanf, __inline_isnan, __inline_isnanl)
...
# 33 "/usr/local/lib/gcc8/gcc/x86_64-portbld-freebsd11.1/8.0.1/include/tgmath.h" 2 3 4


#include <complex.h>
# 35 "/usr/local/lib/gcc8/gcc/x86_64-portbld-freebsd11.1/8.0.1/include/tgmath.h" 3 4
# 1 "/usr/include/complex.h" 1 3 4
# 30 "/usr/include/complex.h" 3 4
#define _COMPLEX_H 
...
double cimag(double _Complex) __attribute__((__const__));
float cimagf(float _Complex) __attribute__((__const__));
long double cimagl(long double _Complex) __attribute__((__const__));
double _Complex conj(double _Complex) __attribute__((__const__));
float _Complex conjf(float _Complex) __attribute__((__const__));
long double _Complex
  conjl(long double _Complex) __attribute__((__const__));
float _Complex cprojf(float _Complex) __attribute__((__const__));
double _Complex cproj(double _Complex) __attribute__((__const__));
long double _Complex
  cprojl(long double _Complex) __attribute__((__const__));
double creal(double _Complex) __attribute__((__const__));
float crealf(float _Complex) __attribute__((__const__));
long double creall(long double _Complex) __attribute__((__const__));
...
# 36 "/usr/local/lib/gcc8/gcc/x86_64-portbld-freebsd11.1/8.0.1/include/tgmath.h" 2 3 4
# 45 "/usr/local/lib/gcc8/gcc/x86_64-portbld-freebsd11.1/8.0.1/include/tgmath.h" 3 4
#define __TGMATH_CPLX(z,R,C) __builtin_tgmath (R ##f, R, R ##l, C ##f, C, C ##l, (z))


#define __TGMATH_CPLX_2(z1,z2,R,C) __builtin_tgmath (R ##f, R, R ##l, C ##f, C, C ##l, (z1), (z2))


#define __TGMATH_REAL(x,R) __builtin_tgmath (R ##f, R, R ##l, (x))

#define __TGMATH_REAL_2(x,y,R) __builtin_tgmath (R ##f, R, R ##l, (x), (y))

#define __TGMATH_REAL_3(x,y,z,R) __builtin_tgmath (R ##f, R, R ##l, (x), (y), (z))

#define __TGMATH_CPLX_ONLY(z,C) __builtin_tgmath (C ##f, C, C ##l, (z))
