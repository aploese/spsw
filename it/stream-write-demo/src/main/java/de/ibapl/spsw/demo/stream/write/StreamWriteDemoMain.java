 ...
 */
package de.ibapl.spsw.demo.stream.write;
 ...
 * @author aploese
 */
public class StreamWriteDemoMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            os = sps.getOutputStream();
        } catch (IOException ioe) {
            System.out.println("de.ibapl.spsw.demo.asciidemo.StreamWriteDemoMain.main() Ex: " + ioe);
            return;
        }
